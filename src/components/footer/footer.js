...
import {FooterContainer,FooterWrapper,Nav,NavLink,SocialMediaIcon,SocialMediaIcons,Copyright } from './footerStyle';
...
const Footer = () => {
  ...
  return (
    ...
    <FooterWrapper>
      ...
      <Copyright>
        &copy; 2024 <span style={{color: theme.secondary, textDecoration: 'underline' , cursor: 'pointer' }}> AAiSH Tech</span> | All rights reserved.
      </Copyright>
